...
extension UIColor {
    static let decisionPurple = UIColor(red: 0.67, green: 0.44, blue: 0.60, alpha: 1.00)
    static let decisionGreen = UIColor(red: 0.65, green: 0.73, blue: 0.51, alpha: 1.00)
    static let decisionPink = UIColor(red: 0.93, green: 0.47, blue: 0.54, alpha: 1.00)
    static let decisionSkyBlue = UIColor(red: 0.65, green: 0.83, blue: 0.85, alpha: 1.00)
    static let decisionOrange = UIColor(red: 0.90, green: 0.55, blue: 0.29, alpha: 1.00)
